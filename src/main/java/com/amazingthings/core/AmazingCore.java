...
public class AmazingCore {
	...
	/**
	 * NOTE: IF TOO MANY ITEMS/BLOCKS IS IN HERE MOVE ITEMS TO AN ITEMS/BLOCKS CLASS
	...
	public void preInit(FMLPreInitializationEvent e) {
		...
		registerBlocks();      //Blocks.registerBlocks();
		registerItems();       //Items.registerItems();
		registerModelBlocks(); //Blocks.registerModelBlocks
	...
	private void registerModelBlocks(){
